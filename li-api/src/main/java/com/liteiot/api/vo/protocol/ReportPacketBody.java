...
/**********************************************************************************************************************************************
 起始符	   | Vx.x |         IMEI08	           |  BatLevel	| Temper02	| len02	|   type  | InfoDcnt | signal | AntEle02
 ---------------------------------------------------------------------------------------------------------------------------------------------
 68		   | 01   | 08 66 95 60  40 08 58 50  |  64	     |     00 85	| 00 1c	|   30	  |  01      |
 --------------------------------------------------------------------------------------------------------------------------------------------
 |    lac04	     |   log04	   |       time06	   |        Acc        |           Gd	    |       Mag	        |   OperaSta |	Swingxyz03
 ----------------------------------------------------------------------------------------------------------------------------------------------
 | 41 b4  40 5f | 42 e3 e1 7a | 15 07 0e 03 1d 28 | ff b0 00 9f 40 b6 |  00 24 fe ad ff eb |  ff d2 fd c5 00 3c|     01     |   00 01 05
 ----------------------------------------------------------------------------------------------------------------------------------------------
      Dsplxyz06    | 校验码 |	结束符
 ---------------------------------------
  0014 0001 0003  | e8  |   7e 7e
 **********************************************************************************************************************************/
