...
package com.liteiot.gate.handler;
    ...
    public AsyncPredicate<ServerWebExchange> applyAsync(Config config) {
        return exchange -> {
            ...
            if (cachedBody != null) {
                ...
                return ServerWebExchangeUtils.cacheRequestBodyAndRequest(exchange, (serverHttpRequest) -> ServerRequest.create(exchange.mutate().request(serverHttpRequest).build(), codecConfigurer.getReaders()).bodyToMono(String.class).defaultIfEmpty("").doOnNext((objectValue) -> {
